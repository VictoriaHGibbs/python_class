#   fix9.5.py - Inhertiance
#
#   This fix is a little more difficult than the previous. First, the code uses
#   the OOP concept of inheritance, so you must spend time reading the 
#   code. 
#   
