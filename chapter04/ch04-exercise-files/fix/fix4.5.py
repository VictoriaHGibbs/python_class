...
# planets is now a tuple (not a list) containing planets in our solor system. The list is in alphabetical order.
...
print("The planets in our solor system")
print(planets)
print("Bring back Pluto!")
planets_including_pluto = planets.append('Pluto')
